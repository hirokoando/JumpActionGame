...
public class GameScreen extends ScreenAdapter {
    ...
    OrthographicCamera mGuiCamera;//GUIcamera
    FitViewport mViewPort;
    FitViewport mGuiViewPort;//GUIviewport
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.hiroko.ando.jumpactiongame");
    ...
    public void render (float delta) {
        ...
        //Enemy
        for(int i = 0; i < mEnemy.size(); i++){ //new
        ...
        mFont.draw(mGame.batch,"HP: " + mHP, 16,GUI_HEIGHT-55);//new
        mGame.batch.end();
    }
